...
/* 2018 02 28 添加用户渠道CODE*/
ALTER TABLE `SYS_APP_USER` ADD COLUMN `CHANNEL_CODE`  varchar(12) NULL COMMENT '渠道CODE' AFTER `SIGN_TAG`;
ALTER TABLE `SYS_USER` ADD COLUMN `CHANNEL_CODE`  varchar(12) NULL COMMENT '渠道CODE';

/* 2018 02 28 添加渠道管理表*/
DROP TABLE IF EXISTS `TB_WWJ_CHANNEL_MANAGE`;
CREATE TABLE `TB_WWJ_CHANNEL_MANAGE` (
		`CHANNEL_CODE` BIGINT(12)  unsigned NOT NULL AUTO_INCREMENT COMMENT '主键ID',
		`CHANNEL_NAME` varchar(255) DEFAULT NULL COMMENT '渠道名称',
		`CHANNEL_KEY` varchar(255) DEFAULT NULL COMMENT '渠道KEY',
		`CHANNEL_STAT` varchar(2) DEFAULT NULL COMMENT '渠道状态',
		`CHANNEL_TYPE` varchar(1) DEFAULT NULL COMMENT '渠道类型',
		`CHANNEL_LEVEL` varchar(1) DEFAULT NULL COMMENT '渠道等级',
		`CHANNEL_PROBABILITY` varchar(12) DEFAULT NULL COMMENT '渠道分成',
		`REMARKS` varchar(255) DEFAULT NULL COMMENT '备注',
