...
public class AppuserService implements AppuserManager {
    ...
    public List<AppUser> getUserRw(AppUser appUser) throws Exception {
        return (List<AppUser>) dao.findForList("AppuserMapper.getUserRw", appUser);
    }
    ...
    public int updateAppUserListForLevelGift() throws Exception {
        return (int) dao.update("AppuserMapper.updateAppUserListForLevelGift", null);
    }

    @Override
    public int updateAppUserInfo(AppUser appUser)throws Exception {
        return (int)dao.update("AppuserMapper.updateAppUserInfo",appUser);
    }


    @Override
    public List<PageData> getpsUser(String userId) throws Exception {
        return (List<PageData>)dao.findForList("AppuserMapper.getpsUser",userId);
    }

    @Override
    public List<PageData> getcpUser(PageData userId) throws Exception {
        return (List<PageData>)dao.findForList("AppuserMapper.getcpUser",userId);
    }

    @Override
    public List<PageData> gettgUser(Page pageData) throws Exception {
        return (List<PageData>)dao.findForList("AppuserMapper.gettgUser",pageData);
    }


    @Override
    public List<PageData> getxxUser(Page page) throws Exception {
        return (List<PageData>)dao.findForList("AppuserMapper.getxxUser",page);
    }
}
