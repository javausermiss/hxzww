...
public class PromoteFranchiseeSubuserController extends BaseController {
	...
	public void delete(PrintWriter out) throws Exception{
		logBefore(logger, Jurisdiction.getUsername()+"删除PromoteFranchiseeSubuser");
	...
	public ModelAndView edit() throws Exception{
		logBefore(logger, Jurisdiction.getUsername()+"修改PromoteFranchiseeSubuser");
	...
	public ModelAndView list(Page page) throws Exception{
		logBefore(logger, Jurisdiction.getUsername()+"列表PromoteFranchiseeSubuser");
		...
		page.setPd(pd);
		List<PageData>	varList = promoteappuser.findAllFranchiseeSubuser(page);
	...
	public Object deleteAll() throws Exception{
		logBefore(logger, Jurisdiction.getUsername()+"批量删除PromoteFranchiseeSubuser");
