		...
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					...
					<form action="pointsdetail/${msg }.do" name="Form" id="Form" method="post">
						<input type="hidden" name="POINTSDETAIL_ID" id="POINTSDETAIL_ID" value="${pd.POINTSDETAIL_ID}"/>
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							...
							<tr>
								...
								<td><input type="text" name="TYPE" id="TYPE" value="${pd.TYPE}" maxlength="255" placeholder="这里输入积分类型" title="积分类型" style="width:98%;"/></td>
							</tr>
							<tr>
