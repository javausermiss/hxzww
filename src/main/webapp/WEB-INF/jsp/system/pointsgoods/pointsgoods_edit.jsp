		...
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					...
					<form action="pointsgoods/${msg }.do" name="Form" id="Form" method="post" enctype="multipart/form-data">
						<input type="hidden" name="POINTSGOODS_ID" id="POINTSGOODS_ID" value="${pd.POINTSGOODS_ID}"/>
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							...
							<tr>
								...
								<td><input type="number" name="POINTS" id="POINTS" value="${pd.POINTS}" maxlength="32" placeholder="这里输入积分" title="积分" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">商品原始价格:</td>
								<td><input type="number" name="ORIGINALVALUEOFGOODS" id="ORIGINALVALUEOFGOODS" value="${pd.ORIGINALVALUEOFGOODS}" maxlength="32" placeholder="这里输入价格" title="价格" style="width:98%;"/></td>
							</tr>
